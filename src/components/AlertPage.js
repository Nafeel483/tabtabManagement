...
import { lighten, makeStyles, fade, useTheme, ThemeProvider, createMuiTheme } from '@material-ui/core/styles';
...
class AlertPage extends React.Component {
  ...
  sendAlert = (value) => {
    ...
    axios
      .post(`${urlFunction()}/restaurant/alert`, data, {
      })
      .then((res) => {
...
export default withStyles(styles)(AlertPage);